...
import { mockStudents, mockInstructors, mockDepartments, mockPendingUsers, mockSubjects } from '@/data/mockData';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={mockInstructors.length * 10}
          icon={GraduationCap}
          variant="secondary"
        />
        <StatCard
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Badge variant="secondary">{mockPendingUsers.length} pending</Badge>
            </CardHeader>
            <CardContent className="space-y-3">
              {mockPendingUsers.map((request) => (
                <div
                  key={request.id}
