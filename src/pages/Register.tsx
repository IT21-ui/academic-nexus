...
import { GraduationCap, User, BookOpen, ArrowLeft, CheckCircle } from 'lucide-react';
        ...
        <Card className="w-full max-w-md border-0 shadow-card text-center">
          <CardContent className="pt-8 pb-8">
            ...
            <p className="text-muted-foreground mb-6">
              Your registration is pending admin approval. Once approved, you will receive your {registrationType === 'student' ? 'Student ID' : 'Instructor ID'} via email.
            </p>
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-primary-foreground">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-md">
            Register as a student or instructor to access your personalized dashboard, 
            manage your academic records, and connect with the university system.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-card">
            <CardHeader className="text-center pb-4">
              <Link to="/login" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-2">
